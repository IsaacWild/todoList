...
btnSubmit.addEventListener('click', () =>{
    ...
    if((title != '') && (description != '') && (date != '')){
        ...
        (0,_todoProjects__WEBPACK_IMPORTED_MODULE_0__.createTodo)(project, title, description, date, priority)
        //close form
        removeForm()
